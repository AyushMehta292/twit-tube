            ...
            <ul className="text-center flex flex-col items-center space-y-2">
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="https://x.com/forAyushMehta"
                    target="_blank"
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="http://www.linkedin.com/in/ayushmehta292"
                    target="_blank"
                    className="text-blue-500 text-sm hover:text-blue-400 "
                  >
                    /ayushmehta292
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="https://github.com/AyushMehta292"
                    target="_blank"
                    className="text-blue-500 text-sm hover:text-blue-400 "
                  >
                    /AyushMehta292
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <p className="text-blue-500 text-sm hover:text-blue-400 ">@_mahiiii_</p>
                </div>
              </li>
            </ul>
          </div>
